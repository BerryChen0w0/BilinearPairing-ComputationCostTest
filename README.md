...
> 基于`math/big`库实现。
>
> 为了实现128-bit安全级别的离散对数问题（DLP），需要使用大约3072-bit的大素数。因此，我们对不同位数的`big.Int`整数运算的性能进行了测试。

测试结果如下：

| 运算类型 | 64-bit   | 128-bit  | 256-bit  | 512-bit    | 1024-bit   | 2048-bit    | 3072-bit     | 4096-bit     |
| :------- | :------- | :------- | :------- | :--------- | :--------- | :---------- | :----------- | :----------- |
| 加法     | 70 ns    | 68 ns    | 68 ns    | 72 ns      | 84 ns      | 110 ns      | 143 ns       | 175 ns       |
| 减法     | 58 ns    | 67 ns    | 66 ns    | 75 ns      | 80 ns      | 101 ns      | 130 ns       | 156 ns       |
| 乘法     | 63 ns    | 76 ns    | 94 ns    | 149 ns     | 282 ns     | 798 ns      | 1.816 µs     | 2.594 µs     |
| 除法     | 72 ns    | 159 ns   | 162 ns   | 187 ns     | 215 ns     | 335 ns      | 394 ns       | 489 ns       |
| 取模     | 51 ns    | 65 ns    | 64 ns    | 67 ns      | 73 ns      | 92 ns       | 114 ns       | 147 ns       |
| 模幂     | 3.766 µs | 7.098 µs | 26.14 µs | 102.766 µs | 547.691 µs | 3.470361 ms | 10.952351 ms | 23.521018 ms |
