...
func GTest_bls12381(t int) {
	var err error
	_, _, g1, g2 := bls12381.Generators()

	// prepare g1, g2, gt
	var P1, Q1, R1 bls12381.G1Affine
	var P2, Q2, R2 bls12381.G2Affine
	var Pt, Qt, Rt bls12381.GT
	var a, b *big.Int
...
func PairingTest_bls12381(t int) {
	var err error
	_, _, g1, g2 := bls12381.Generators()
...
func BLS12381_Test() {
	const t = 1e4
	fmt.Println("BLS12381 Computation Cost Test")
	fmt.Println("")
	FTest_bls12381(t)
	fmt.Println("")
	GTest_bls12381(t)
	fmt.Println("")
	PairingTest_bls12381(t)
	fmt.Println("")
	fmt.Println("BLS12381 Computation Cost Test Completed")
}
